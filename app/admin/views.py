...
from app import db
from app.models import Admin, Tag, Movie, Preview, User, Comment, Moviecol, OpLog, AdminLog, Usrelog, Auth
from . import admin
from app.admin.forms import LoginForm, TagFrom, MoiveForm, PreviewForm, PwdFrom, AuthFrom
